...
//		theGraph.addEdge(0, 1, 50); // AB 50
//		theGraph.addEdge(0, 3, 50); // AD 80
//		theGraph.addEdge(1, 2, 50); // BC 60
//		theGraph.addEdge(1, 3, 50); // BD 90
//		theGraph.addEdge(2, 4, 50); // CE 40
//		theGraph.addEdge(3, 2, 50); // DC 20
//		theGraph.addEdge(3, 4, 50); // DE 70
//		theGraph.addEdge(4, 1, 50); // EB 50
//		//构造无向图
